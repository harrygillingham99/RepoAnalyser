...
export class Client extends AuthorizedApiBase {
  ...
  pullRequest_GetPullRequests(
    ...
    url_ = url_.replace(
      "{pullFilterOption}",
      encodeURIComponent("" + pullFilterOption)
    );
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processPullRequest_GetPullRequests(
    response: Response
  ): Promise<UserPullRequestResult[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processPullRequest_GetDetailedPullRequest(
    response: Response
  ): Promise<DetailedPullRequest> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @param metadata (optional) Client Metadata JSON
   */
  pullRequest_GetPullRequestSummary(
    repoId: number,
    pullNumber: number,
    metadata: any | undefined
  ): Promise<PullSummaryResponse> {
  ...
  protected processPullRequest_GetPullRequestSummary(
    response: Response
  ): Promise<PullSummaryResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processRepository_GetDetailedRepository(
    response: Response
  ): Promise<DetailedRepository> {
    const status = response.status;
    let _headers: any = {};
  ...
  repository_GetCyclomaticComplexities(
    connectionId: string,
    metadata: any | undefined,
    request: CyclomaticComplexityRequest
  ...
  protected processRepository_GetCyclomaticComplexities(
    response: Response
  ): Promise<{ [key: string]: number }> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processRepository_GetCodeOwnersForRepo(
    response: Response
  ): Promise<{ [key: string]: string }> {
    const status = response.status;
    let _headers: any = {};
  ...
  repository_GetFileInformation(
    ...
    let url_ =
      this.baseUrl + "/repositories/file-info/{repoId}/{fileName}/{extension}";
    if (repoId === undefined || repoId === null)
      throw new Error("The parameter 'repoId' must be defined.");
    url_ = url_.replace("{repoId}", encodeURIComponent("" + repoId));
    if (fileName === undefined || fileName === null)
  ...
  protected processRepository_GetFileInformation(
    response: Response
  ): Promise<GitHubCommit[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processRepository_GetRepoIssues(
    response: Response
  ): Promise<RepoIssuesResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  repository_GetRepoContributionVolumes(
    ...
    connectionId: string,
    metadata: any | undefined
  ): Promise<RepoContributionResponse> {
  ...
  protected processRepository_GetRepoContributionVolumes(
    response: Response
  ): Promise<RepoContributionResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processRepository_GetRepoSummary(
    response: Response
  ): Promise<RepoSummaryResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processRepository_GetGendarmeReportHtml(
    response: Response
  ): Promise<string> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processStatistics_GetUserStatistics(
    response: Response
  ): Promise<UserActivity> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @param metadata (optional) Client Metadata JSON
   */
  statistics_GetLandingPageStatistics(
    metadata: any | undefined
  ): Promise<UserLandingPageStatistics> {
  ...
  protected processStatistics_GetLandingPageStatistics(
    response: Response
  ): Promise<UserLandingPageStatistics> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUtilities_GetDetailedRepository(
    response: Response
  ): Promise<boolean> {
    const status = response.status;
    let _headers: any = {};
...
export class UserPullRequestResult implements IUserPullRequestResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.closedAt = _data["closedAt"]
        ? new Date(_data["closedAt"].toString())
        : <any>undefined;
      this.updatedAt = _data["updatedAt"]
        ? new Date(_data["updatedAt"].toString())
        : <any>undefined;
      ...
      if (Array.isArray(_data["collaborators"])) {
        ...
        for (let item of _data["collaborators"]) this.collaborators!.push(item);
      }
      this.title = _data["title"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.collaborators)) {
      data["collaborators"] = [];
      for (let item of this.collaborators) data["collaborators"].push(item);
    }
    data["title"] = this.title;
...
export class DetailedPullRequest implements IDetailedPullRequest {
  ...
  init(_data?: any) {
    if (_data) {
      this.pullRequest = _data["pullRequest"]
        ? UserPullRequestResult.fromJS(_data["pullRequest"])
        : <any>undefined;
  ...
  toJSON(data?: any) {
    data = typeof data === "object" ? data : {};
    data["pullRequest"] = this.pullRequest
      ? this.pullRequest.toJSON()
      : <any>undefined;
    if (Array.isArray(this.commits)) {
      data["commits"] = [];
      for (let item of this.commits) data["commits"].push(item.toJSON());
    }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.repository = _data["repository"]
        ? Repository.fromJS(_data["repository"])
        : <any>undefined;
    }
  }
  ...
  init(_data?: any) {
    ...
    if (_data) {
      this.author = _data["author"]
        ? Author.fromJS(_data["author"])
        : <any>undefined;
      this.commentsUrl = _data["commentsUrl"];
      this.commit = _data["commit"]
        ? Commit.fromJS(_data["commit"])
        : <any>undefined;
      this.committer = _data["committer"]
        ? Author.fromJS(_data["committer"])
        : <any>undefined;
      this.htmlUrl = _data["htmlUrl"];
      this.stats = _data["stats"]
        ? GitHubCommitStats.fromJS(_data["stats"])
        : <any>undefined;
...
export class Commit extends GitReference implements ICommit {
  ...
  init(_data?: any) {
    ...
    if (_data) {
      this.message = _data["message"];
      this.author = _data["author"]
        ? Committer.fromJS(_data["author"])
        : <any>undefined;
      this.committer = _data["committer"]
        ? Committer.fromJS(_data["committer"])
        : <any>undefined;
      this.tree = _data["tree"]
        ? GitReference.fromJS(_data["tree"])
        : <any>undefined;
      if (Array.isArray(_data["parents"])) {
        this.parents = [] as any;
        for (let item of _data["parents"])
      ...
      this.verification = _data["verification"]
        ? Verification.fromJS(_data["verification"])
        : <any>undefined;
    }
  }
...
export class Repository implements IRepository {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.pushedAt = _data["pushedAt"]
        ? new Date(_data["pushedAt"].toString())
        : <any>undefined;
      this.createdAt = _data["createdAt"]
        ? new Date(_data["createdAt"].toString())
        : <any>undefined;
      ...
      this.parent = _data["parent"]
        ? Repository.fromJS(_data["parent"])
        : <any>undefined;
      this.source = _data["source"]
        ? Repository.fromJS(_data["source"])
        : <any>undefined;
      this.license = _data["license"]
        ? LicenseMetadata.fromJS(_data["license"])
        : <any>undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.reason = _data["reason"]
        ? StringEnumOfVerificationReason.fromJS(_data["reason"])
        : <any>undefined;
...
export class StringEnumOfVerificationReason
  implements IStringEnumOfVerificationReason {
...
export class DetailedRepository implements IDetailedRepository {
  ...
  init(_data?: any) {
    if (_data) {
      this.repository = _data["repository"]
        ? UserRepositoryResult.fromJS(_data["repository"])
        : <any>undefined;
      if (Array.isArray(_data["commits"])) {
        this.commits = [] as any;
        for (let item of _data["commits"])
      ...
      this.statistics = _data["statistics"]
        ? RepoStatistics.fromJS(_data["statistics"])
        : <any>undefined;
      if (_data["codeOwners"]) {
      ...
      this.codeOwnersLastUpdated = _data["codeOwnersLastUpdated"]
        ? new Date(_data["codeOwnersLastUpdated"].toString())
        : <any>undefined;
      this.isDotNetProject = _data["isDotNetProject"];
      if (_data["cyclomaticComplexities"]) {
        ...
        for (let key in _data["cyclomaticComplexities"]) {
          if (_data["cyclomaticComplexities"].hasOwnProperty(key))
            this.cyclomaticComplexities![key] =
              _data["cyclomaticComplexities"][key];
        }
      }
      this.cyclomaticComplexitiesLastUpdated = _data[
        "cyclomaticComplexitiesLastUpdated"
      ]
        ? new Date(_data["cyclomaticComplexitiesLastUpdated"].toString())
        : <any>undefined;
      this.staticAnalysisLastUpdated = _data["staticAnalysisLastUpdated"]
        ? new Date(_data["staticAnalysisLastUpdated"].toString())
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data["codeOwnersLastUpdated"] = this.codeOwnersLastUpdated
      ? this.codeOwnersLastUpdated.toISOString()
      : <any>undefined;
    data["isDotNetProject"] = this.isDotNetProject;
    if (this.cyclomaticComplexities) {
      ...
      for (let key in this.cyclomaticComplexities) {
        if (this.cyclomaticComplexities.hasOwnProperty(key))
          data["cyclomaticComplexities"][key] = this.cyclomaticComplexities[
            key
          ];
      }
    }
    data["cyclomaticComplexitiesLastUpdated"] = this
      .cyclomaticComplexitiesLastUpdated
      ? this.cyclomaticComplexitiesLastUpdated.toISOString()
      : <any>undefined;
    data["staticAnalysisLastUpdated"] = this.staticAnalysisLastUpdated
      ? this.staticAnalysisLastUpdated.toISOString()
      : <any>undefined;
...
export class RepoStatistics implements IRepoStatistics {
  ...
  init(_data?: any) {
    if (_data) {
      this.codeFrequency = _data["codeFrequency"]
        ? CodeFrequency.fromJS(_data["codeFrequency"])
        : <any>undefined;
      this.commitActivity = _data["commitActivity"]
        ? CommitActivity.fromJS(_data["commitActivity"])
        : <any>undefined;
      this.participation = _data["participation"]
        ? Participation.fromJS(_data["participation"])
        : <any>undefined;
      this.commitPunchCard = _data["commitPunchCard"]
        ? PunchCard.fromJS(_data["commitPunchCard"])
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    data = typeof data === "object" ? data : {};
    data["codeFrequency"] = this.codeFrequency
      ? this.codeFrequency.toJSON()
      : <any>undefined;
    data["commitActivity"] = this.commitActivity
      ? this.commitActivity.toJSON()
      : <any>undefined;
    data["participation"] = this.participation
      ? this.participation.toJSON()
      : <any>undefined;
    data["commitPunchCard"] = this.commitPunchCard
      ? this.commitPunchCard.toJSON()
      : <any>undefined;
    return data;
  }
}
    ...
    if (_data) {
      if (Array.isArray(_data["additionsAndDeletionsByWeek"])) {
        ...
        for (let item of _data["additionsAndDeletionsByWeek"])
          this.additionsAndDeletionsByWeek!.push(
            AdditionsAndDeletions.fromJS(item)
          );
      }
    }
  }
...
export class CommitActivity implements ICommitActivity {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.activity)) {
      data["activity"] = [];
      for (let item of this.activity) data["activity"].push(item.toJSON());
    }
    return data;
  }
}
...
export class WeeklyCommitActivity implements IWeeklyCommitActivity {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["days"])) {
        this.days = [] as any;
        for (let item of _data["days"]) this.days!.push(item);
      }
      this.total = _data["total"];
      this.week = _data["week"];
      this.weekTimestamp = _data["weekTimestamp"]
        ? new Date(_data["weekTimestamp"].toString())
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.days)) {
      data["days"] = [];
      for (let item of this.days) data["days"].push(item);
    }
    data["total"] = this.total;
    data["week"] = this.week;
    data["weekTimestamp"] = this.weekTimestamp
      ? this.weekTimestamp.toISOString()
      : <any>undefined;
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      this.dayOfWeek = _data["dayOfWeek"]
        ? StringEnumOfDayOfWeek.fromJS(_data["dayOfWeek"])
        : <any>undefined;
...
export class CyclomaticComplexityRequest
  implements ICyclomaticComplexityRequest {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["filesToSearch"])) {
        ...
        for (let item of _data["filesToSearch"]) this.filesToSearch!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.filesToSearch)) {
      data["filesToSearch"] = [];
      for (let item of this.filesToSearch) data["filesToSearch"].push(item);
    }
...
export class RepoIssuesResponse implements IRepoIssuesResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["issues"])) {
        this.issues = [] as any;
        for (let item of _data["issues"]) this.issues!.push(Issue.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.issues)) {
      data["issues"] = [];
      for (let item of this.issues) data["issues"].push(item.toJSON());
    }
    return data;
  }
}
...
export class Issue implements IIssue {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.state = _data["state"]
        ? StringEnumOfItemState.fromJS(_data["state"])
        : <any>undefined;
      this.title = _data["title"];
      this.body = _data["body"];
      this.closedBy = _data["closedBy"]
        ? User.fromJS(_data["closedBy"])
        : <any>undefined;
      this.user = _data["user"] ? User.fromJS(_data["user"]) : <any>undefined;
      if (Array.isArray(_data["labels"])) {
        this.labels = [] as any;
        for (let item of _data["labels"]) this.labels!.push(Label.fromJS(item));
      }
      this.assignee = _data["assignee"]
        ? User.fromJS(_data["assignee"])
        : <any>undefined;
      ...
      this.milestone = _data["milestone"]
        ? Milestone.fromJS(_data["milestone"])
        : <any>undefined;
      this.comments = _data["comments"];
      this.pullRequest = _data["pullRequest"]
        ? PullRequest.fromJS(_data["pullRequest"])
        : <any>undefined;
      this.closedAt = _data["closedAt"]
        ? new Date(_data["closedAt"].toString())
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.assignees)) {
      data["assignees"] = [];
      for (let item of this.assignees) data["assignees"].push(item.toJSON());
    }
    data["milestone"] = this.milestone
      ? this.milestone.toJSON()
      : <any>undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.createdAt = _data["createdAt"]
        ? new Date(_data["createdAt"].toString())
        : <any>undefined;
      this.dueOn = _data["dueOn"]
        ? new Date(_data["dueOn"].toString())
        : <any>undefined;
      this.closedAt = _data["closedAt"]
        ? new Date(_data["closedAt"].toString())
        : <any>undefined;
...
Merged via rebase - the hash of the commit that the base branch was updated to. */
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.closedAt = _data["closedAt"]
        ? new Date(_data["closedAt"].toString())
        : <any>undefined;
      this.mergedAt = _data["mergedAt"]
        ? new Date(_data["mergedAt"].toString())
        : <any>undefined;
      this.head = _data["head"]
        ? GitReference.fromJS(_data["head"])
        : <any>undefined;
      this.base = _data["base"]
        ? GitReference.fromJS(_data["base"])
        : <any>undefined;
      this.user = _data["user"] ? User.fromJS(_data["user"]) : <any>undefined;
      this.assignee = _data["assignee"]
        ? User.fromJS(_data["assignee"])
      ...
      this.mergeableState = _data["mergeableState"]
        ? StringEnumOfMergeableState.fromJS(_data["mergeableState"])
        : <any>undefined;
      this.mergedBy = _data["mergedBy"]
        ? User.fromJS(_data["mergedBy"])
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data["mergeableState"] = this.mergeableState
      ? this.mergeableState.toJSON()
      : <any>undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.privacy = _data["privacy"]
        ? StringEnumOfTeamPrivacy.fromJS(_data["privacy"])
        : <any>undefined;
      this.permission = _data["permission"]
        ? StringEnumOfPermissionLevel.fromJS(_data["permission"])
        : <any>undefined;
      this.membersCount = _data["membersCount"];
      this.reposCount = _data["reposCount"];
      this.organization = _data["organization"]
        ? Organization.fromJS(_data["organization"])
        : <any>undefined;
      this.parent = _data["parent"]
        ? Team.fromJS(_data["parent"])
        : <any>undefined;
      this.ldapDistinguishedName = _data["ldapDistinguishedName"];
    }
  }
...
export class StringEnumOfPermissionLevel
  implements IStringEnumOfPermissionLevel {
  stringValue?: string | undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.subject = _data["subject"]
        ? NotificationInfo.fromJS(_data["subject"])
        : <any>undefined;
      this.reason = _data["reason"];
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.repo = _data["repo"]
        ? Repository.fromJS(_data["repo"])
        : <any>undefined;
      this.actor = _data["actor"]
        ? User.fromJS(_data["actor"])
        : <any>undefined;
      this.org = _data["org"]
        ? Organization.fromJS(_data["org"])
        : <any>undefined;
      this.createdAt = _data["createdAt"]
        ? new Date(_data["createdAt"].toString())
        : <any>undefined;
      this.id = _data["id"];
      this.payload = _data["payload"]
        ? ActivityPayload.fromJS(_data["payload"])
        : <any>undefined;
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.installation = _data["installation"]
        ? InstallationId.fromJS(_data["installation"])
        : <any>undefined;
    }
  }
      ...
      if (_data["topRepoActivity"]) {
        ...
        for (let key in _data["topRepoActivity"]) {
          if (_data["topRepoActivity"].hasOwnProperty(key))
            this.topRepoActivity![key] = _data["topRepoActivity"][key]
              ? CommitActivity.fromJS(_data["topRepoActivity"][key])
              : new CommitActivity();
        }
      }
      if (_data["languages"]) {
    ...
    if (this.topRepoActivity) {
      ...
      for (let key in this.topRepoActivity) {
        if (this.topRepoActivity.hasOwnProperty(key))
          data["topRepoActivity"][key] = this.topRepoActivity[key]
            ? this.topRepoActivity[key].toJSON()
            : <any>undefined;
      }
    }
    if (this.languages) {
