...
export class Client extends AuthorizedApiBase {
    ...
    example_Test(statusToReturn: number): Promise<TestResponse> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processExample_Test(_response);
        });
    }

    protected processExample_Test(response: Response): Promise<TestResponse> {
